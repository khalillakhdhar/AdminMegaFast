          ...
          <div class="content-card today-deliveries">
            <div class="card-header">
              ...
              <span class="count-badge">{{
                dashboardData.todayDeliveries.length
              }}</span>
            </div>
            <div class="card-content">
              <div
                class="delivery-list"
                *ngIf="
                  dashboardData.todayDeliveries.length > 0;
                  else noDeliveries
                "
              >
                <div
                  class="delivery-item"
                  *ngFor="let delivery of dashboardData.todayDeliveries"
                >
          ...
          <div class="content-card recent-shipments">
            ...
            <div class="card-content">
              ...
              >
                <div
                  class="shipment-item"
                  *ngFor="let shipment of dashboardData.recentShipments"
                >
...
export class DriverDashboardComponent implements OnInit, OnDestroy {
  ...
  private updateDeliveryStatusChart(): void {
    ...
    const data = [
      ...
      {
        label: "Retournés",
        value: stats.returnedShipments || 0,
        color: "#dc3545",
      },
      {
        label: "Autres",
