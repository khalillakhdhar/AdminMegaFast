...
export class HorizontaltopbarComponent implements OnInit, AfterViewInit {
  ...
  constructor(@Inject(DOCUMENT) private readonly document: any, private readonly router: Router, private readonly eventService: EventService, private readonly authService: AuthenticationService) {
  ...
  _activateMenuDropdown() {
    ...
    if (itemIndex === -1) {
      ...
      const item = window.location.pathname.substring(0, strIndex).toString();
