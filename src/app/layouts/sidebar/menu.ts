...
export const MENU: MenuItem[] = [
  ...
  { id: 2, label: 'Tableau de bord', icon: 'bx-home-circle', link: '/megafast/dashboard' },

  {
    ...
    subItems: [
      ...
      { id: 5, label: 'Créer un colis', link: '/megafast/colis/create', parentId: 3 },
    ]
  },

  {
    ...
    icon: 'bx-user',
    subItems: [
      { id: 7, label: 'Liste des clients', link: '/megafast/clients', parentId: 6 },
      { id: 22, label: 'Dashboard clients', link: '/megafast/clients/dashboard', parentId: 6 },
    ]
  },

  {
    ...
    subItems: [
      ...
      { id: 9,  label: 'Liste des livreurs',   link: '/megafast/drivers',         parentId: 8 },
      { id: 10, label: 'Ajouter un livreur',   link: '/megafast/drivers/create',  parentId: 8 },
    ]
  },
